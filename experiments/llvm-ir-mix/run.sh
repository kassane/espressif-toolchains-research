...
"$LDC2" -mtriple=xtensa-esp-elf -mcpu=esp32 $LDC_PE -betterC -O1 -output-ll -of="$B/lib_d.ll" "$M/d/lib_d.d" 2>/dev/null
...
"$LDC2" -mtriple=xtensa-esp-elf -mcpu=esp32 $LDC_PE -betterC -O0 -output-ll -of="$B/callee.ll" "$B/callee.d" 2>/dev/null
"$LDC2" -mtriple=xtensa-esp-elf -mcpu=esp32 $LDC_PE -betterC -O0 -output-ll -of="$B/caller.ll" "$B/caller.d" 2>/dev/null
...
"$LDC2" -mtriple=xtensa-esp-elf -mcpu=esp32 $LDC_PE -betterC -O1 -output-bc -of="$B/lib_d.bc" "$M/d/lib_d.d" 2>/dev/null
