...
experiments/zero-cost/    run.sh {esp32|esp32s2|esp32s3|esp32c3|esp32p4} — D × C++ × Rust × C zero-cost abstraction parity: monomorphization, lambdas/Fn-traits, static vs dynamic dispatch, heap-allocated classes. Parameterized across xtensa (esp32 baseline) AND riscv (esp32c3 / esp32p4); ISA-portable conclusion (docs/25 §"RISC-V variant"; toolchain matrix in docs/09)
